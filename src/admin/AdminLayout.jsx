...
import {
  ...
  Wallet2, Shop, Warning2, VideoPlay, Bag2, Messages2, Notification,
} from 'iconsax-react'
...
const NAV = [
  ...
  { to: '/admin/storefront-orders', label: 'Storefront Orders', Icon: Bag2 },
  ...
  { to: '/admin/complaints',    label: 'Complaints',       Icon: Messages2 },
