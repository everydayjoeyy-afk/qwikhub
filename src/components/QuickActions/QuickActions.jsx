...
import { Box, Gift, Shop } from 'iconsax-react'
import styles from './QuickActions.module.css'

const ACTIONS = [
  { id: 'bundle', label: 'Bundle', icon: Box,  bg: '#000000', iconColor: '#ffffff', path: '/orders' },
  { id: 'earn',   label: 'Earn',   icon: Gift, bg: '#FFCC08', iconColor: '#000000', path: '/refer'  },
